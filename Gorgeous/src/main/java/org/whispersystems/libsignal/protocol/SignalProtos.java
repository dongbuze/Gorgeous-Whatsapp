...
public final class SignalProtos {
  ...
  public interface FastRatchetSenderKeyDistributionMessageOrBuilder extends
     ...
     * @return A list containing the chainKeys.
     */
    java.util.List<com.google.protobuf.ByteString> getChainKeysList();
    /**
     * <code>repeated bytes chainKeys = 3;</code>
     * @return The count of chainKeys.
     */
    int getChainKeysCount();
    /**
     * <code>repeated bytes chainKeys = 3;</code>
     * @param index The index of the element to return.
     * @return The chainKeys at the given index.
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    private FastRatchetSenderKeyDistributionMessage(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
      super(builder);
    }
    ...
    protected java.lang.Object newInstance(
        UnusedPrivateParameter unused) {
      return new FastRatchetSenderKeyDistributionMessage();
    }
    ...
    private FastRatchetSenderKeyDistributionMessage(
      ...
      try {
        ...
        if (((mutable_bitField0_ & 0x00000004) != 0)) {
          chainKeys_ = java.util.Collections.unmodifiableList(chainKeys_); // C
        }
        this.unknownFields = unknownFields.build();
        makeExtensionsImmutable();
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof org.whispersystems.libsignal.protocol.SignalProtos.FastRatchetSenderKeyDistributionMessage)) {
        return super.equals(obj);
      }
      org.whispersystems.libsignal.protocol.SignalProtos.FastRatchetSenderKeyDistributionMessage other = (org.whispersystems.libsignal.protocol.SignalProtos.FastRatchetSenderKeyDistributionMessage) obj;
      ...
      if (!getChainKeysList()
          .equals(other.getChainKeysList())) return false;
      if (hasSigningKey() != other.hasSigningKey()) return false;
      if (hasSigningKey()) {
        if (!getSigningKey()
            .equals(other.getSigningKey())) return false;
    ...
    public int hashCode() {
      ...
      if (getChainKeysCount() > 0) {
        hash = (37 * hash) + CHAINKEYS_FIELD_NUMBER;
        hash = (53 * hash) + getChainKeysList().hashCode();
      }
      if (hasSigningKey()) {
        hash = (37 * hash) + SIGNINGKEY_FIELD_NUMBER;
        hash = (53 * hash) + getSigningKey().hashCode();
    ...
    public static final class Builder extends
      ...
      public java.util.List<com.google.protobuf.ByteString>
          getChainKeysList() {
        return ((bitField0_ & 0x00000004) != 0) ?
                 java.util.Collections.unmodifiableList(chainKeys_) : chainKeys_;
      }
      /**
       * <code>repeated bytes chainKeys = 3;</code>
       * @return The count of chainKeys.
       ...
       * @param value The chainKeys to set.
       * @return This builder for chaining.
       */
  ...
  ensureChainKeysIsMutable();
      ...
      /**
       * <code>repeated bytes chainKeys = 3;</code>
       * @param value The chainKeys to add.
       * @return This builder for chaining.
       */
  ...
  ensureChainKeysIsMutable();
      ...
      /**
       * <code>repeated bytes chainKeys = 3;</code>
       * @param values The chainKeys to add.
       * @return This builder for chaining.
       */
  ...
  bitField0_ |= 0x00000008;
    ...
    private static final org.whispersystems.libsignal.protocol.SignalProtos.FastRatchetSenderKeyDistributionMessage DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new org.whispersystems.libsignal.protocol.SignalProtos.FastRatchetSenderKeyDistributionMessage();
    }

    public static org.whispersystems.libsignal.protocol.SignalProtos.FastRatchetSenderKeyDistributionMessage getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }

    @java.lang.Deprecated public static final com.google.protobuf.Parser<FastRatchetSenderKeyDistributionMessage>
        PARSER = new com.google.protobuf.AbstractParser<FastRatchetSenderKeyDistributionMessage>() {
      @java.lang.Override
